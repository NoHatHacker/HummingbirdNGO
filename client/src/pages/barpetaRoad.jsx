...
export default function BarpetaRoad() {
  ...
  useEffect(() => {
    const fetchMembers = async () => {
      try {
        const res = await api.get("/members?regionalCircle=barpeta_road");
    ...
    const fetchEvents = async () => {
      try {
        const res = await api.get("/events?regionalCircle=barpeta_road");
        ...
        <div className={styles.teamSec}>
          <div className={styles.teamSectionRow}>
            <div>
              ...
              <p className={styles.teamSecSubtitle}>
                Empowering regional communities through sustainable environmental and skill-building projects.
              </p>
            </div>
          </div>
          ...
          {directors.length === 0 ? (
            <p style={{ textAlign: "center", padding: "2rem", color: "#64748b" }}>
              No team members assigned to Barpeta Road circle yet.
            </p>
          ) : (
          ...
          <div className={styles.eventSec}>
            <div>
              ...
              <p className={styles.eventSecSubtitle}>
                Key initiatives and community programs organized by the Barpeta Road circle.
              </p>
            </div>
          </div>
